...
type(
	// item defines the fields asscociated with the item tag
	// in the rss document
	item struct{
	...
	// channel defined the fields asscoiated with the channel tag
	// in the rss document.
	channel struct {
...
func (m rssMatcher) Search(feed *search.Feed, searchTerm string) ([]*search.Result, error){
	...
	for _, channelItem := range docuemnt.Channel.Item{
